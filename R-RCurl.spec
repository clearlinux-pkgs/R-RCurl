...
Version  : 1.98.1.13
Release  : 113
URL      : https://cran.r-project.org/src/contrib/RCurl_1.98-1.13.tar.gz
Source0  : https://cran.r-project.org/src/contrib/RCurl_1.98-1.13.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1699024203
