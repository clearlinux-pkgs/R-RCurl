...
Version  : 1.98.1.6
Release  : 100
URL      : https://cran.r-project.org/src/contrib/RCurl_1.98-1.6.tar.gz
Source0  : https://cran.r-project.org/src/contrib/RCurl_1.98-1.6.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1644366425
