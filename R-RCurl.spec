...
Version  : 1.98.1.10
Release  : 109
URL      : https://cran.r-project.org/src/contrib/RCurl_1.98-1.10.tar.gz
Source0  : https://cran.r-project.org/src/contrib/RCurl_1.98-1.10.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1674839005
