...
Version  : 1.98.1.8
Release  : 103
URL      : https://cran.r-project.org/src/contrib/RCurl_1.98-1.8.tar.gz
Source0  : https://cran.r-project.org/src/contrib/RCurl_1.98-1.8.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1659369466
