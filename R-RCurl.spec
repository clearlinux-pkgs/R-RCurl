...
Source0  : https://cran.r-project.org/src/contrib/RCurl_1.98-1.16.tar.gz
...
%setup -q -n RCurl
pushd ..
cp -a RCurl buildavx2
popd
pushd ..
cp -a RCurl buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720717731
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/RCurl/libs/RCurl.so
/V4/usr/lib64/R/library/RCurl/libs/RCurl.so
